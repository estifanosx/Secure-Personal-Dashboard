 ...
 <!--  form , graph and pie charts -->
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6"> 
       ...
       <div class="rounded-xl bg-slate-800/50 border         border-slate-700/60 p-5 flex flex-col">
                  ...
                  <div class="js-chart-container flex-1 flex flex-col items-center justify-center min-h-[220px] bg-slate-900/40 border border-dashed border-slate-700 rounded-lg p-4 text-center"> 
                      </div>
              </div>
